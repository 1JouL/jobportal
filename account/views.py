...
def recruiter_dashboard(request):
    ...
    total_application = JobApplication.objects.filter(jobs__posted_by = user).count()
    most_applied_job = (
...
def student_applied_jobs(request):
    ...
    return render(request,'account/student_applied_jobs.html',{'application':applications})